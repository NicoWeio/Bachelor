...
%
\todo{
  As of now, only the Wasserstein distance is dominantly used.
  However, the other metrics will help with
    discussing the results
    and comparing them to prior works.
}
...
The \emph{mean absolute error} (\textsc{Mae}) is a metric that is commonly used for regression tasks. % TODO
It is defined as
\begin{equation}
