...
This is verified by the initial Bayesian optimization (\autoref{sec:hyperparameters:initial_bayesian}),
  where the results have no correlation with the learning rate.
...
The data is split into $k = 10$ \emph{folds} of equal size. % not to be confused with DSEA's iteration index k
...
\begin{figure}
  ...
  \centering
  \includegraphics[scale=0.75]{content/plots/hyperparam/combined_pcplot_full.pdf}
  \caption{
