...
The boxplot in \autoref{fig:hyperparameter:epsilon} shows the results of a grid search for the convergence threshold
  (as described in \autoref{sec:dsea:dsea:stepsize:adaptive}).
...
The adaptive step size function,
  which has been explained in \autoref{sec:dsea:dsea:stepsize:adaptive}, % TODO: Schon bei epsilon verlinkt
