...
The adaptive step size function,
  which has been explained in \autoref{sec:dsea:dsea:step_size:adaptive}, % TODO: Schon bei epsilon verlinkt
...
\begin{figure}
  ...
  % TODO: Plot J=250, since we used that before.
